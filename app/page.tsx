...
export default function LandingPage() {
  ...
  return (
    // Outer wrapper: fills screen with forest green on sides (letterbox on desktop)
    <div style={{ backgroundColor: '#26452B', minHeight: '100dvh', display: 'flex', justifyContent: 'center' }}>
      <main
        style={{
          width: '100%',
          maxWidth: 480,
